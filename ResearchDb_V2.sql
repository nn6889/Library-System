...
ALTER TABLE papers DISABLE KEYS ;
...
ALTER TABLE papers ENABLE KEYS;
UNLOCK TABLES;
...
CREATE TABLE authorship(
    ...
    CONSTRAINT fk_faculty FOREIGN KEY (facultyId) REFERENCES faculty (id) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT fk_papers FOREIGN KEY (paperId) REFERENCES papers (id) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
ALTER TABLE authorship DISABLE KEYS ;
INSERT INTO authorship VALUES (1,1),(1,2),(1,3),(1,5),(2,3);
 ALTER TABLE authorship ENABLE KEYS ;
UNLOCK TABLES;
...
CREATE TABLE paper_keywords (
  ...
  CONSTRAINT pk_faculty FOREIGN KEY (id) REFERENCES papers (id) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
ALTER TABLE paper_keywords DISABLE KEYS;
...
ALTER TABLE paper_keywords ENABLE KEYS ;
UNLOCK TABLES;
